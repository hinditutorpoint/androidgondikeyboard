...
public class LatinKeyboard extends Keyboard {
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y,
        ...
        } else if (key.codes[0] == GondiKeyboardView.KEYCODE_LANGUAGE_SWITCH) {
    ...
    public void setLanguageSwitchKeyVisibility(boolean visible) {
        if (visible) {
            ...
            if (mSavedModeChangeKey.width>0) {
    ...
    public void setImeOptions(Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            ...
            case EditorInfo.IME_ACTION_SEARCH:
                mEnterKey.icon = ResourcesCompat.getDrawable(res, R.drawable.ic_baseline_search_24, null);
            ...
            case EditorInfo.IME_ACTION_SEND:
                ...
                break;
            default:
                mEnterKey.icon = ResourcesCompat.getDrawable(res, R.drawable.ic_baseline_keyboard_return_24, null);
                mEnterKey.label = null;
                break;
        }
    }
